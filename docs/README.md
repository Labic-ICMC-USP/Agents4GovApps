...
Welcome to the Agents4Gov documentation. This directory now contains the current packaging protocol plus legacy guides kept for reference.
...
- **[Tool Protocol](tool_protocol.md)** - The current installable-library contract for new tools and packages.
- **[How to Create a Tool](how_to_create_tool.md)** - Legacy step-by-step guide kept for reference after the repo extraction.
